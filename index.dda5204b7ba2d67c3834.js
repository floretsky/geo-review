...
/******/ 	return __webpack_require__(__webpack_require__.s = "./develop/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!**************************!*\
  !*** ./develop/index.js ***!
  \**************************/
/*! exports provided: basicStorage, placemarksCoords */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "basicStorage", function() { return basicStorage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "placemarksCoords", function() { return placemarksCoords; });
/* harmony import */ var _styles_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/style.css */ "./develop/styles/style.css");
...
/* harmony import */ var _js_map__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/map */ "./develop/js/map.js");
/* harmony import */ var _js_navigate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/navigate */ "./develop/js/navigate.js");
...
/*!***************************!*\
  !*** ./develop/js/map.js ***!
  \***************************/
/*! exports provided: clusterer, myMap, loadMap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! .. */ "./develop/index.js");
/* harmony import */ var _review__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./review */ "./develop/js/review.js");
/* harmony import */ var _placemark__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./placemark */ "./develop/js/placemark.js");
/* harmony import */ var _templates_popup_hbs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../templates/popup.hbs */ "./develop/templates/popup.hbs");
/* harmony import */ var _templates_popup_hbs__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_templates_popup_hbs__WEBPACK_IMPORTED_MODULE_3__);
...
function loadMap() {
  ...
  var balloonLayout = ymaps.templateLayoutFactory.createClass(_templates_popup_hbs__WEBPACK_IMPORTED_MODULE_3___default()(), {
    ...
    getShape: function getShape() {
      ...
      if (this._element) {
        ...
        return new ymaps.shape.Rectangle(new ymaps.geometry.pixel.Rectangle([[position.left, position.top], [position.left + this._element.offsetWidth, position.top + this._element.offsetHeight]]));
      }
    }
  });
  ...
  clusterer = new ymaps.Clusterer({
    ...
    // переопределяем кастомный popup на стандартный
    clusterBalloonItemContentLayout: customItemContentLayout,
    clusterBalloonPanelMaxMapArea: 0,
    // не будет открываться в режиме панели
    clusterBalloonPagerSize: 5,
    // кол-во страниц
    groupByCoordinates: false,
    // если true то группирует только с одинаковыми координатами
    clusterDisableClickZoom: true,
    // отключаем зумирование при клике на кластер
...
/***/ "./develop/js/navigate.js":
/*!********************************!*\
  !*** ./develop/js/navigate.js ***!
  \********************************/
/*! exports provided: navigateFromCarousel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "navigateFromCarousel", function() { return navigateFromCarousel; });
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ "./node_modules/@babel/runtime/helpers/toConsumableArray.js");
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! .. */ "./develop/index.js");
/* harmony import */ var _map_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./map.js */ "./develop/js/map.js");



function navigateFromCarousel() {
  document.addEventListener('click', function (e) {
    ...
    if (elem.classList.contains('ballon__link')) {
      ...
      myReverseGeocoder.then(function () {
        ...
        _map_js__WEBPACK_IMPORTED_MODULE_2__["myMap"].balloon.open(point.properties.coords, {
          properties: {
...
/***/ "./develop/js/placemark.js":
/*!*********************************!*\
  !*** ./develop/js/placemark.js ***!
  \*********************************/
/*! exports provided: getPlacemarks, addPlacemark */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPlacemarks", function() { return getPlacemarks; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addPlacemark", function() { return addPlacemark; });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! .. */ "./develop/index.js");
/* harmony import */ var _map_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./map.js */ "./develop/js/map.js");
    ...
    for (var _iterator = ___WEBPACK_IMPORTED_MODULE_0__["basicStorage"][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      try {
        for (var _iterator2 = item.reviews[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          if (placemark) {
            _map_js__WEBPACK_IMPORTED_MODULE_1__["clusterer"].add(placemark);
          }
        }
      } catch (err) {
...
function addPlacemark(point, newReview) {
  if (___WEBPACK_IMPORTED_MODULE_0__["placemarksCoords"].length) {
    ...
    placemark.events.add('click', function () {
      _map_js__WEBPACK_IMPORTED_MODULE_1__["myMap"].balloon.open(point.properties.coords, {
        properties: {
          address: point.properties.address,
          coords: point.properties.coords
        },
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! .. */ "./develop/index.js");
/* harmony import */ var _map_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./map.js */ "./develop/js/map.js");
/* harmony import */ var _placemark_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./placemark.js */ "./develop/js/placemark.js");





function createReview(point) {
  var name = document.querySelector('#review-name');
  var place = document.querySelector('#review-place');
  ...
  if (_map_js__WEBPACK_IMPORTED_MODULE_1__["myMap"].balloon.isOpen()) {
    _map_js__WEBPACK_IMPORTED_MODULE_1__["myMap"].balloon.open(point.properties.coords, {
      properties: {
        address: point.properties.address,
        coords: point.properties.coords
